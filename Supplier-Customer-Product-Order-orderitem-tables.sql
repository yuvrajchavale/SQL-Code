...
Create table Customer([Id] int,[FirstName] varchar(30),[LastName] varchar(30),[City]varchar(30),[Country]varchar(20),[Phone] varchar(15))
...
Create table Supplier([Id] int,[CompanyName] varchar(50),[ContactName]varchar(50),[City]varchar(30),[Country]varchar(30),[Phone]varchar(20),[Fax] varchar(30))
...
Create table Product([Id] int,[ProductName] varchar (50),[SupplierId] int,[UnitPrice] float,[Package] varchar(50),[IsDiscontinued] int)
...
INSERT INTO [Product] ([Id],[ProductName],[SupplierId],[UnitPrice],[Package],[IsDiscontinued])VALUES(7,'Uncle Bobs Organic Dried Pears',3,30.00,'12 - 1 lb pkgs.',0)
...
Create table [Order] ([Id] int,[OrderDate] datetime,[CustomerId] int,[TotalAmount] float,[OrderNumber] varchar(30))
...
Create table OrderItem([Id] int,[OrderId] int,[ProductId] int,[UnitPrice] float,[Quantity] int)
